...
public class ConnectDatabase {
    ...
    static  String DB_URL =    "jdbc:sqlserver://localhost;";          //  "jdbc:sqlserver://localhost;";
    static  String DATABASENAME = "databaseName=DBEmployee;";       //  "databaseName=quanlybanhang;";
    static  String USER =  "user=sa;";              //  "user=sa;";
    static  String PASS ="password=ngocminh58";                //  "password=ngocminh58";
