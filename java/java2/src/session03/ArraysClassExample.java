...
/*
java.util.Arrays là một lớp đặc biệt trong java, nó bao gồm rất nhiều phương thức (method) 
dạng static chuyên dụng cho việc thao tác trên mảng như là tìm kiếm và sắp xếp, 
ngoài ra nó còn bao gồm phương thức cho phép chuyển mảng thành dạng danh sách (list).
*/
