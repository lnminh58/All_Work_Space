 ...
 */
public class session02_baitap3 {

    String name;

    public session02_baitap3(String name) {
        this.name = name;
    }

    static void sosanh3(session02_baitap3 obj1, session02_baitap3 obj2) {
    ...
    public static void main(String[] args) {
        session02_baitap3 obj1 = new session02_baitap3("object1");
        session02_baitap3 obj2 = new session02_baitap3("object2");
//        obj1=obj2;
        sosanh3(obj1, obj2);
    }
}
