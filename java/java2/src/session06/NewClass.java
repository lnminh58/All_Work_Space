...
Đọc dữ liệu nguồn, nén nó theo định dạng "deflate", sau đó ghi ra
output stream
Inflater Thực hiện nhiệm vụ giải nén
InflaterInputStream Đọc dữ liệu nguồn rồi giải nén theo định dạng "deflate"
InflaterOutputStream
Đọc dữ liệu nguồn rồi giải nén theo định dạng "deflate", sau đó ghi ra
luồng xuất
ZipInputStream
Thực thi một bộ lọc luồng nhận để đọc các file theo định dạng tập tin
ZIP. Hỗ trợ các đầu vào nén và giải nén.
