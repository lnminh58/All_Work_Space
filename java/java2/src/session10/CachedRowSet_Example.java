...
public class CachedRowSet_Example {
    ...
    static final String PASS = "ngocminh58";
...
duyệt bản ghi theo nhiều cách. Một khi ột đối tượng CachedRowSet là có thể cuộn (scrollable) con trỏ nằm tại dòng mong muốn, các phương thức getter 
